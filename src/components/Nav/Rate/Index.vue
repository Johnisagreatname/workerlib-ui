<script lang="ts">
    ...
    import RateStore from '../../../store/modules/RateStore';
    ...
    export default class Rate extends Vue {
        ...
        constructor() {
            ...
            this.store = getModule(RateStore);
        }
...
<style scoped src="@/styles/rate.css" />
<template lang="pug" src="@/views/rate.pug" />
