<script lang="ts">
    ...
    import CommentTypeStore from '../../../store/modules/CommentTypeStore';
    ...
    export default class CommentType extends Vue {
        ...
        constructor() {
            ...
            this.store = getModule(CommentTypeStore);
        }
...
<style scoped src="@/styles/commentType.css" />
<template lang="pug" src="@/views/commentType.pug" />
