...
//     await request
//       .post("/api/workerlib/dictionaries", {
//         pageInfo: {},
//         conditionList: [
//           {
//             name: "category",
...
//   public async search() {
//     await request
//       .post("/api/workerlib/join", await this.getParams())
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     await request
//       .post("/api/workerlib/teamrate", await this.getViewParams())
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//   public async count() {
//     await request
//       .post("/api/workerlib/join/count", await this.getParams())
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     await request
//       .post("/api/workerlib/teamrate/count", await this.getViewParams())
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     await request
//       .put("/api/workerlib/user_rate", this.insertUser)
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     }
//     await request
//       .put("/api/workerlib/team_user", this.insertTeamUserList)
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     await request
//       .post("/api/workerlib/people", await this.getPeopleParams())
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     await request
//       .post("/api/workerlib/join", await this.getViewRateParams())
//       .then((data) => {
//         if (!data) {
//           return;
//         }
...
//     await request
//       .post("/api/workerlib/people/count", await this.getPeopleParams())
//       .then((total) => {
//         if (!total) {
//           return;
//         }
...
//     await request
//       .post("/api/workerlib/join/count", await this.getViewRateParams())
//       .then((total) => {
//         if (!total) {
//           return;
//         }
